// recorded-course\skillo-frontend\src\components\blog\BlogListing.tsx
'use client';
                ...
                >
                  ...
                  <div className="p-5">
                    ...
                    <p className="text-sm text-gray-500 mb-2">
                      {truncatedDesc}
                      {isTruncated && (
                        <span className="text-[#016ab7] font-medium ml-1 inline-block group-hover:text-[#6cb84d] transition-colors">
                          Read more
                        </span>
                      )}
                    </p>
