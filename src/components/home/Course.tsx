...
export default function CourseListing() {
  ...
  const handleViewDetails = (course: any) => {
    const slug = course.slug?.trim() || slugify(course.title);
    router.push(`/course/${encodeURIComponent(slug)}`);
  };
            ...
            {courses.map((course) => {
              ...
              return (
                ...
                >
                  ...
                  {/* Content */}
                  <div className="p-5">
                    <h3 className="text-lg font-bold leading-tight text-slate-900 group-hover:text-[#016ab7] transition-colors line-clamp-2">
                      {course.title}
                    </h3>
                    ...
                    <div className="mt-4 grid grid-cols-2 gap-2">
                      ...
                      {purchaseUrl ? (
                        <a
                          href={purchaseUrl}
                          className="flex items-center justify-center rounded-lg border-2 border-[#016ab7] bg-transparent px-4 py-2.5 text-sm font-medium text-[#016ab7] transition-all hover:bg-[#016ab7] hover:text-white hover:shadow-lg hover:shadow-[#016ab7]/25"
                        >
                          Buy Now
                        </a>
                      ) : (
