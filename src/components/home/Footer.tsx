...
const footerLinks = {
  ...
  "Top Categories": [
    { name: "Achievo", href: "https://shikshanation.com" },
    { name: "Skillo", href: "/" },
  ],
  "Useful Links": [
    { name: "FAQs", href: "/faqs" },
...
const appLinks = [
  { icon: FaGooglePlay, label: "Get it on Google Play", href: "https://play.google.com/store/apps/details?id=com.tagmango.skillo&hl=en_IN" },
  { icon: FaApple, label: "Download on the App Store", href: "https://apps.apple.com/in/app/skillox/id6756077365" },
];
