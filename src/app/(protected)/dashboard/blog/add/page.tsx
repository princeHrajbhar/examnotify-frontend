...
export default function AddBlogPage() {
  ...
  const exampleBlogJson = `{
  "title": "Example Blog Title",
  "slug": "example-blog-title",
  "description": "A short description with at least ten characters.",
  "seoTitle": "Example SEO Title",
  "seoDescription": "Example SEO description for search engines.",
  "keywords": ["example", "blog", "testing"],
  "content": "<h2>Introduction</h2><p>Paste your blog content here.</p>",
  "faqs": [
    {
      "question": "What is this blog about?",
      "answer": "This is a temporary example answer."
    }
  ],
  "socialMediaLinks": [
    {
